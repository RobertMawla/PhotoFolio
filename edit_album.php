...
<head>
  ...
  <title>PhotoFolio - Edit Album</title>
  ...
  <main id="main" data-aos="fade" data-aos-delay="1500">
    ...
    <section id="contact" class="contact">
        ...
        Nama Album<div class="form-group mt-3">
                <input type="text" class="form-control" name="namaalbum" value="<?=$data['namaalbum']?>" style="background-color: var(--color-secondary); color: #fff; border: none;" autocomplete="off">    
</div>
Deskripsi<div class="form-group mt-3">
                <input type="text" class="form-control" name="deskripsi" value="<?=$data['deskripsi']?>"style="background-color: var(--color-secondary); color: #fff; border: none;" autocomplete="off">      
</div>     
<p><br></p>
<div class="col-md-6">
