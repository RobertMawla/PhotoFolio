    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if(mysqli_num_rows($cek_email) > 0) {
            ...
            if(mysqli_num_rows($cek_username) > 0) {
                ...
                // Jika email dan username belum terdaftar, lakukan proses penyimpanan data
...
.login-box form button {
  ...
  /* Updated styles for transparency */
  background: transparent; /* Set the background to transparent */
  border: 2px solid #03e9f4; /* Set the border color to match the text color */
  color: #03e9f4; /* Set the text color */
}

.login-box button:hover {
  background: #03e9f4; /* Change the background color on hover */
  color: #fff;
  border-radius: 5px;
...
.password-toggle:hover {
  ...
  <div class="user-box">
    ...
    <div class="user-box">
      <input type="text" name="namalengkap" required="" autocomplete="off">
    ...
    <button onclick="window.location.href='login.php'" style="margin-left:60px">
    <span></span>
      <span></span>
      <span></span>
      <span></span>
    ...
    <button onclick="window.location.href='landing.php'" style="margin-left:110px">
    <span></span>
      <span></span>
      <span></span>
      <span></span>
